...
func (r *ReconcileVirusScan) assertServiceAccount(ctx context.Context, s *avv1beta1.VirusScan) (*corev1.ServiceAccount, error) {
...
func (r *ReconcileVirusScan) assertRoleBinding(ctx context.Context, a *corev1.ServiceAccount) (*rbacv1.RoleBinding, error) {
