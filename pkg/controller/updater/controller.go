...
func (u *UpdaterController) Start(i <-chan struct{}) error {
	ticker := time.NewTicker(30 * time.Minute)
	retry := make(chan struct{})

	reconcileOrRetry := func() {
		res, err := u.reconcile(context.Background())
		if err != nil {
...
func (u *UpdaterController) reconcile(ctx context.Context) (reconcile.Result, error) {
	ds := appsv1.DaemonSet{}
	...
	return reconcile.Result{}, u.upsert(ctx, &ds)
}
...
func (u *UpdaterController) upsert(ctx context.Context, obj runtime.Object) error {
